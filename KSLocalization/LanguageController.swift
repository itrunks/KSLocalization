...
//  KSLocalization
//
//  Created by Raja Pitchai on 07/06/21.
...
class LanguageController: NSObject,LanguagePickerViewDelegate {
    ...
    func didTapDone(lang: DictionaryLanguage) {
        showOrHidePicker()
        KSLocalizationManager.sharedInstance.setCurrentBundle(forLanguage: lang.code)
        UserDefaults.selectedLanguage = lang.code
        NotificationCenter.default.post(name: Notification.Name(KSConstants.Notifications.LanguageChangeNotification), object: nil)
